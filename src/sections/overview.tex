...
%Nodes
\node[squarednode, text width=5cm] (msc) 			at (0,0)	{ MSc Thesis: Autonomous Landing of a Multicopter Using Computer Vision };
\node[squarednode, text width=5cm] (raven_fagradalsfjall) 	at (7,-2) 	{ Heavy-lift experiment over Fagradalsfjall, Summer 2021 };
...
\node[squarednode, text width=6cm] (raven_fieldwork_2022)	at (7,-5.5)	{ RAVEN fieldwork, Summer 2022 };
\node[squarednode, text width=6cm] (lava_landing_concept)	at (7, -6.5)	{ Lava flow landing concept };
\node[squarednode, text width=5cm] (refinement)			at (0,-8)	{ Refinement of proof of concept to mitigate erroneous control signals };
\node[squarednode, text width=6cm] (lava_processing)		at (7,-8)	{ How to process 3D data from lava flows };
\node[squarednode, text width=6cm] (lava_landing_implementation)		at (7,-10)	{ Lava flow landing implementation };
\node[squarednode, text width=6cm] (unified)		at (3.5,-11) 	{ Unified solution };
...
\draw[->] (evaluation.south) -- (poc.north);
\draw[->] (poc.south) -- (refinement.north);
\draw[->] (refinement.south) -- (unified.north);
...
\draw[->] (lava_landing_implementation.south) -- (unified.north);
